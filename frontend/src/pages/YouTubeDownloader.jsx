...
import YouTubeResponse from "../components/YouTube-Response";
import { Helmet } from "react-helmet-async";
import SocialTags from "../components/SocialTags";

const YouTubeDownloader = () => {
  const { handleYouTubeUrl, input, setInput, isDownloading, downloadUrl } =
  ...
  return (
    <>
      <Helmet>
        <title>
          Youtube Video Downloader - Free Videos Downloader | SocioDown
        </title>
        <meta
          name="description"
          content="Download Youtube videos and shorts easily with SocioDown. No login, fast, and completely free."
        />
        <link rel="canonical" href="https://yourdomain.com/" />
        <meta
          property="og:title"
          content="Download Youtube Videos - SocioDown"
        />
        <meta
          property="og:description"
          content="Fast and free Youtube downloader. videos, shorts."
        />
        <meta
          property="og:image"
      ...
      <div className="w-full min-h-screen bg-zinc-200 pb-4">
        <div className="w-full flex flex-col gap-8 px-[20px] py-[30px] items-center shadow-xl bg-linear-to-r from-red-700 to-red-500">
          ...
          <div className="flex flex-col gap-4 w-full md:max-w-2xl">
            <div className="relative w-full max-w-2xl flex max-sm:flex-col items-center justify-between sm:gap-4 gap-10 md:p-2 rounded bg-white">
              ...
              <button
                className={`hidden sm:block px-6 py-4 border sm:px-4 sm:py-4 rounded font-semibold text-sm sm:text-base text-white w-full sm:w-auto cursor-pointer ${
                  downloadUrl
                    ? "bg-gray-500"
