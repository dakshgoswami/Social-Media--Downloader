...
import TwitterResponse from "../components/Twitter-Response";
...
const TwitterDownloader = () => {
  const { handleTwitterUrl, input, setInput, isDownloading, downloadUrl } =
  ...
  return (
    <>
      <Helmet>
        <title>
          Twitter Video Downloader - Free Videos Downloader | SocioDown
        </title>
        <meta
          name="description"
          content="Download Twitter videos easily with SocioDown. No login, fast, and completely free."
        />
        <link rel="canonical" href="https://yourdomain.com/twitter" />
        <meta
          property="og:title"
          content="Download Twitter Videos - SocioDown"
        />
        <meta
          property="og:description"
          content="Fast and free Twitter downloader. Videos, Twits."
        />
        <meta
          property="og:image"
      ...
      <div className="w-full min-h-screen bg-zinc-200 pb-4">
        <div className="w-full flex flex-col gap-8 px-[20px] py-[30px] items-center shadow-xl bg-linear-to-r from-blue-900 to-blue-500">
            ...
            <div className="relative w-full max-w-2xl flex max-sm:flex-col items-center justify-between sm:gap-4 gap-10 md:p-2 rounded bg-white">
              <div className="w-full flex justify-between items-center sm:gap-2">
                <input
                  ...
                  className="w-full text-base sm:text-base py-5 px-4 sm:py-4 rounded md:bg-gray-300 text-black focus:outline-blue-500"
                />
                <button
              ...
              <button
                className={`hidden sm:block border px-6 py-4 sm:px-4 sm:py-4 rounded font-semibold text-sm sm:text-base text-white w-full sm:w-auto cursor-pointer ${
                  downloadUrl
                    ? "bg-gray-500"
                    : "bg-linear-to-r from-blue-900 to-blue-500"
                }`}
